...
export class Network {
  constructor(public info: siriusjsNetwork) {
  }
  ...
  /**
   * Restore 10 wallet addresses exported from sirius's mobile clients. These
...
const mainnet = new Network(siriusjsNetworks.sirius)
const testnet = new Network(siriusjsNetworks.sirius_testnet)
