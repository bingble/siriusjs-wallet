import {
  networks as siriusjsNetworks,
  Network as siriusjsNetwork
} from "siriusjs-lib"
import axios, { AxiosInstance } from "axios"

const INSIGHT_BASEURLS: { [key: string]: string } = {
  [siriusjsNetworks.sirius.name]: "http://zacanbot.hopto.org:3001/sirius-insight-api",
  [siriusjsNetworks.sirius_testnet.name]: "https://localhost:3001/sirius-insight-api",
}
...
export class Insight {
  ...
  public static forNetwork(network: siriusjsNetwork): Insight {
